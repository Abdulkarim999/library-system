    ...
    <div class="container">
      <div class="row">
		...
		<div style="margin: 30px;" class="row">
				...
				<div class="col-md-8">
					<input class="form-control" type="search" name="search" placeholder="Search for book title, author name" id="">
				</div> 
            ...
            <div class="col-lg-6 currently-market-item all msc">
              <div class="item">
                ...
                <div class="right-content">
                  <h4>{{$data->title}} </h4>
                  <span class="author">
                    <img src="book/{{$data->author_img}}" alt="" style="max-width: 50px; border-radius: 50%;">
                  ...
                  <div class="text-button">
				   ...
				   <div class="">
                    <a class="btn btn-primary" href="{{url('borrow_book',$data->id)}}">Appy to Borrow</a>
                  </div>
                </div>
              </div>
            </div>
